                ...
                title: RichText(
                  text: new TextSpan(
                    ...
                    children: <TextSpan>[
                      ...
                      new TextSpan(
                        text: "These reserved words (keywords) may not be used as constants or variables or any other identifier names.",
                        style: new TextStyle(
                          fontWeight: FontWeight.w300,
                        ),
                      ),
    ...
    return TableRow(
      children: listOfNames.split(',').map((name) {
        return Container(
          ...
          child: Text(name, style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w200,)),
